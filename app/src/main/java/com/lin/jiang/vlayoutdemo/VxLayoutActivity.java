 ...
 * @author jianglin
 */
public class VxLayoutActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                mFirstText.setText("First: " + virtualLayoutManager.findFirstVisibleItemPosition());
                ...
                mTotalOffsetText.setText("Total offset: " + virtualLayoutManager.getOffsetToStart());
            }
        });

        virtualLayoutManager.setRecycleOffset(300);
        recyclerView.setLayoutManager(virtualLayoutManager);
//        virtualLayoutManager.setReverseLayout(true);
                ...
                public MainViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
                    if (viewType == 1) {
                        return new MainViewHolder(
                                LayoutInflater.from(VxLayoutActivity.this).inflate(R.layout.view_pager, parent, false));
                    }
...

        {
            ...
            layoutHelper.setWeights(new float[]{10f, 26.665f});
...
//            layoutHelper.setOffset(100);
        ...
        trigger = new Runnable() {
            ...
            public void run() {
                ...
                //newAdapters.add((new SubAdapter(VxLayoutActivity.this, new ColumnLayoutHelper(), 3)));
                //newAdapters.add((new SubAdapter(VxLayoutActivity.this, new GridLayoutHelper(4), 24)));
                //delegateAdapter.addAdapter(0, new SubAdapter(VxLayoutActivity.this, new ColumnLayoutHelper(), 3));
                //delegateAdapter.addAdapter(1, new SubAdapter(VxLayoutActivity.this, new GridLayoutHelper(4), 24));
    ...
    static class SubAdapter extends DelegateAdapter.Adapter<MainViewHolder> {
        ...
        @Override
        protected void onBindViewHolderWithOffset(MainViewHolder holder, int position, int offsetTotal) {
            Logger.d("item position = %d, offsetTotal = %d", position, offsetTotal);
